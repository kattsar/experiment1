...
This experiment was created using PsychoPy3 Experiment Builder (v2022.2.4),
    on Σεπτέμβριος 20, 2023, at 10:14
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='D:\\GitHub\\experiment1\\REPSWITCH1_Practice1_version1 - Copy_lastrun.py',
...
for thisTrialsPractice in trialsPractice:
    ...
    while continueRoutine and routineTimer.getTime() < 4.0:
        ...
        if micPractice1v1.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            ...
            # add timestamp to datafile
            thisExp.timestampOnFlip(win, 'micPractice1v1.started')
        ...
        if micPractice1v1.status == STARTED:
            ...
            if tThisFlipGlobal > micPractice1v1.tStartRefresh + 4-frameTolerance:
                ...
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'micPractice1v1.stopped')
