...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='D:\\GitHub\\experiment1\\REPSWITCH1_Fam.py',
...
# Get word for each trial
word = textFam.setText(correctAns, log=False)
...
for thisFamTrial in famTrials:
    ...
    clipFilename = f"recording_p{participant_number}_trial{str(count)}_{word}_%s.wav" % tag
