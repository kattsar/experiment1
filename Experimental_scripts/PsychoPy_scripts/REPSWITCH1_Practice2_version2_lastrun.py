...
expName = 'REPSWITCH1_Practice2_version2'  # from the Builder filename that created this script
expInfo = {
...
data_file = "repswitch_practice2_version2.xlsx"  
...
trialsPractice_2 = data.TrialHandler(nReps=1.0, method='sequential', 
    ...
    trialList=data.importConditions('repswitch_practice2_version2.xlsx'),
...
for thisTrialsPractice_2 in trialsPractice_2:
    ...
    clipFilename = f"recording_Practice2v2_p{participant_number}_tr{str(count)}_{respModal}_{correctAns}_%s.wav" % tag
