...
This experiment was created using PsychoPy3 Experiment Builder (v2022.2.4),
    on Φεβρουάριος 08, 2024, at 12:38
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='D:\\GitHub\\experiment1\\Experimental_scripts\\PsychoPy_scripts\\REPSWITCH1_Fam_lastrun.py',
...
famTrials = data.TrialHandler(nReps=1.0, method='random', 
    ...
    trialList=data.importConditions('D:/GitHub/experiment1/Experimental_scripts/Lists/repswitch_fam.xlsx'),
...
for thisFamTrial in famTrials:
    ...
    while continueRoutine and routineTimer.getTime() < 7.0:
        ...
        # micFam updates
        if micFam.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            ...
            # add timestamp to datafile
            thisExp.timestampOnFlip(win, 'micFam.started')
        ...
        if micFam.status == STARTED:
            ...
            if tThisFlipGlobal > micFam.tStartRefresh + 7-frameTolerance:
                ...
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'micFam.stopped')
