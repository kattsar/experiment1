...
header_row$ = "Filename" + tab$ + "Transcription" + tab$  + "Duration(ms.)"+  tab$  + "SOT" +  tab$ + "Notes" +  tab$   + "Exclude" + "Modality_Correct" + tab$ + "Item_Correct" + tab$ + "Hesitation" + tab$ + newline$ 
...
#Only Extract Formant Info on Intervals Labeled With V
          if interval_label$ = "sounding"
              ...
              fileappend "'outDirectory$'TestDataKaterina.txt" 'object_name$''tab$''tier_two$''tab$''duration:3''tab$''sot:3''tab$''notes$''tab$''exclude$''tab$''newline$'
          endif
     endfor
