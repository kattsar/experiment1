...
inDirectory$ = "D:\GitHub\experiment1\data\000101_REPSWITCH1_version1_list1_2023-09-28_10h57.15.798_micRespv1l1_recorded\"
...
header_row$ = "Filename" + tab$ + "Transcription" + tab$  + "Duration(ms.)"+  tab$  + "SOT" +  tab$ + "Modality_Correct" + tab$ + "Item_Correct" + tab$ + "Hesitation" + tab$ + "Notes" +  tab$  + "Exclude" + tab$ + newline$ 
...
#Only Extract Formant Info on Intervals Labeled With V
          if interval_label$ = "sounding"
              ...
              fileappend "'outDirectory$'TestDataKaterina.txt" 'object_name$''tab$''tier_two$''tab$''duration:3''tab$''sot:3''tab$''modality_correct$''tab$''item_correct$''tab$''hesitation$''tab$''notes$''tab$''exclude$''tab$''newline$'
          endif
     endfor
