...
function General_Instr_1RoutineBegin(snapshot) {
  return async function () {
    ...
    General_Instr_1Components.forEach( function(thisComponent) {
...
function General_Instr_2RoutineBegin(snapshot) {
  return async function () {
    ...
    General_Instr_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function General_Instr_3RoutineBegin(snapshot) {
  return async function () {
    ...
    General_Instr_3Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function InstructionsPracticeRoutineBegin(snapshot) {
  return async function () {
    ...
    InstructionsPracticeComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
